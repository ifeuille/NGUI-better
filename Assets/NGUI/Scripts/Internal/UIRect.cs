...
public abstract class UIRect : MonoBehaviour
{
	...
	public class AnchorPoint
	{
		...
		public Vector3[] GetSides (Transform relativeTo, EnumSideType sideType = EnumSideType.AdaptTwoSide)
		{
			if (target != null)
			{
				if (rect != null) return rect.GetSides(relativeTo, sideType);
    ...
    public enum EnumSideType
    {
        // both sides
        AdaptTwoSide = 0,
        // do not adapt
        DontAdapt = 1,
        // only need adapt left side based on the phone toward
        AdaptCutoutAtLeft = 2,
        // only need adapt right side based on the phone toward
        AdaptCutoutAtRight = 3,
    }

    /// <summary>
    ///  Adapt 
    /// </summary>
    public EnumSideType SideType = EnumSideType.AdaptTwoSide;
	...
	{
		if (anchorCamera != null) return mCam.GetSides(cameraRayDistance, relativeTo, sideType);
