...
public class UIWidget : UIRect
{
...
#if UNITY_EDITOR
    [HideInInspector] [SerializeField] public int mLayer = 0;
    [HideInInspector] [SerializeField] public bool mIsFunction = false;
#endif
    ...
    /// <summary>
    /// Mark the widget and the panSelfUpdateel as having been changed.
    /// </summary>
	...
	protected override void OnAnchor ()
	{
		...
		{
			Vector3[] sides = leftAnchor.GetSides(parent, SideType);
